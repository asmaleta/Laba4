...
import laba3.creatures.IDunamic;
...
public class Main {
    public static void main(String[] args){
            ...
            Rat emma1= new Rat("Эмма", 25, Character.Gender.FEMALE, Character.Color.GREY, Character.TypeOfSkin.SHRIVELED, angle, Character.Direction.EAST);
